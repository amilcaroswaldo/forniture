...
import { kitchenProducts } from "@/lib/data/detailsProducts";

export const metadata = {
  title: "Cocinas | Catálogo | MuebleHogar",
  description:
    "Explora nuestra colección de cocinas modulares, islas y accesorios para tu hogar",
};
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Diseños exclusivos para crear la cocina de tus sueños
          </p>
        </div>
      </div>

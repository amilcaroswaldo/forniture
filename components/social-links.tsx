...
const socialLinks: SocialLink[] = [
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/dekomuebles.sv/",
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/people/Deko-Muebles/pfbid02QSKBWhumnhJbY2ngqVsvCLSat2b67BvXoc5pBJEf1MtpHEAky47N54fHd3tbU3arl/",
  ...
  return (
    ...
    >
      <button
        ...
        className="bg-background border border-r-0 border-border h-12 w-8 flex items-center justify-center rounded-l-md shadow-md"
        aria-label={isCollapsed ? "Expandir redes sociales" : "Colapsar redes sociales"}
      >
